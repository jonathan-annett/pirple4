    ...
    */
    helpers.mergeVariables  = function (raw,variables,spacer,cb){
        ...
        var find_arrays = function(i) {
            ...
            if (cond_key.substr(-2)==='[]' && typeof cond.content == 'string') { 
                // this key is an array 
                var data_key=cond_key.substr(cond_key.length-2); 
                var array = vars[data_key];
                
                if ( typeof array ==='object' && 
                     array.constructor===Array ) {
                    //there is indeed an array in vars
                    return helpers.mergeVariableArray(cond.content,array,spacer,function(cooked){
                    ...
                    // fill in vars["myArray[]"] with alternate content, or empty string if none defined
                    vars[cond_key] = typeof cond.altContent === 'string' ? cond.altContent : '';
